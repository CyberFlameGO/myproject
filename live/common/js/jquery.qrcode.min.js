        ...
        return this.each(function() {
            ...
            if ("canvas" == h.render) {
                ...
                function createCanvas(){
                	...
                	a.addData(toUtf8(h.text));
                	a.make();
                	c.width = toPx(h.width);
                	c.height = toPx(h.height);
                	for (var d = c.getContext("2d"), b = c.width / a.getModuleCount(), e = c.height / a.getModuleCount(), f = 0; f < a.getModuleCount(); f++) for (var i = 0; i < a.getModuleCount(); i++) {
                ...
                for (e = 0; e < a.getModuleCount(); e++) {
                    ...
                    for (i = 0; i < a.getModuleCount(); i++){
                    	r("<td></td>").css({
                    		"width": d + "px",
                    		"background-color": a.isDark(e, i) ? h.foreground: h.background
                    	}).appendTo(f)
                    }
                }
            }
...
function toPx(num){
	if(num.search(/px/) > -1){
		return parseInt(num);
	}else if(num.search(/rem/) > -1){
		var a = parseInt($('html').css('font-size'));
		return parseFloat(num) * a;
	}
}
// 转换中文
function toUtf8(str) {   
