var host = "/activityweb/";

var serverErrorString = "服务器错误";
var noOrder = "亲，您暂无订单";
var noInsurance = "亲，您暂无保单";
...
var syncData = function(api,type,params,callback){
	...
	// var apiurl = host + api;
	// var apiurl = 'http://10.100.209.203:8088/activityWeb/' + api;
	var apiurl = 'http://vtest.foreseamall.com/activityWeb/' + api;
	//var apiurl = 'https://v.foreseamall.com/activityWeb/' + api;
	// var apiurl = 'http://10.50.133.180:8080/activityWeb/' + api;
	// var apiurl = 'http://ActivityELB4-2110934744.cn-north-1.elb.amazonaws.com.cn:8081/activityWeb/' + api;
	// var apiurl = 'https://vtest.foreseamall.com/activityWeb/' + api;
	

	$.ajax({
		url: apiurl + '?ts='+new Date().getTime(),
		// url: apiurl,
		...
		error:function (xhr, textStatus, errorThrown) {
			callback(salert(NOINTERNETPROMPT));
		}
	})
};
