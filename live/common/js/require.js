...
*/
var requirejs, require, define, requireloop = 0; (function(Z) {
    function H(b) {
    ...
    function ha(b) {
        ...
        function e(a) {
            z && y(document.getElementsByTagName("script"),
            function(f) {
        ...
        function n(a, f, b, d) {
            ...
            a = a[1];
            g && (g = c(g, e, d), B = l(r, g));
            a && (g ? k = B && B.normalize ? B.normalize(a,
            function(a) {
                return c(a, e, d)
        ...
        function J(a) {
            ...
            b = i.onScriptError; (!a.detachEvent || W) && a.removeEventListener("error", b, !1);
            return {
                node: a,
        ...
        X.prototype = {
            ...
            callPlugin: function() {
                ...
                function(d) {
                    ...
                    if (this.map.unnormalized) {
                        ...
                        function(a) {
                            return c(a, g, !0)
                        }) || ""), d = n(a.prefix + "!" + e, this.map.parentMap), s(d, "defined", u(this,
                        function(a) {
                            this.init([],
                            function() {
                                return a
                            ...
                            this.depMaps.push(d);
                            if (this.events.error) e.on("error", u(this,
                            function(a) {
                                this.emit("error", a)
                            }));
                            e.enable()
            ...
            enable: function() {
                ...
                function(a, b) {
                    ...
                    c = a.id;
                    d = p[c]; ! t(N, c) && (d && !d.enabled) && i.enable(a, this)
                }));
                F(this.pluginMaps, u(this,
                function(a) {
                    var b = l(p, a.id);
        ...
        i = {
            ...
            configure: function(a) {
                ...
                F(p,
                function(a, b) { ! a.inited && !a.map.unnormalized && (a.map = n(b))
                });
            ...
            load: function(a, b) {
            	requireloop == 0 ? b += "?bust=" + (new Date()).getTime() : "";
            	requireloop++;
                j.load(i, a, b)
            },
    ...
    if ("undefined" === typeof define) {
        ...
        j = requirejs = function(b, c, e, h) {
            var q, n = "_"; ! I(b) && "string" !== typeof b && (q = b, I(c) ? (b = c, c = e, e = h) : b = []);
            q && q.context && (n = q.context); (h = l(E, n)) || (h = E[n] = j.s.newContext(n));
            q && h.configure(q);
        ...
        define = function(b, c, e) {
            ...
            I(c) || (e = c, c = null); ! c && H(e) && (c = [], e.length && (e.toString().replace(la, "").replace(ma,
            function(b, e) {
                c.push(e)
            }), c = (1 === e.length ? ["require"] : ["require", "exports", "module"]).concat(c)));
            if (O) {
                if (! (h = K)) P && "interactive" === P.readyState || M(document.getElementsByTagName("script"),
                function(b) {
